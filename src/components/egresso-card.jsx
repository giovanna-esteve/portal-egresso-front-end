...
function EgressoCard (props){
    return (
        <div className="p-1 pb-5">

        <Card style={{ width: '18rem', }} key={props.egressos.id}>
            ...
            <Card.Body>
                <Card.Title>{props.egressos.nome} </Card.Title>
                <Card.Text>
                Egresso do Curso de Ciencia da computação.
                </Card.Text>
                <div className="d-flex justify-content-center">
                    <Button href={`#/egresso/${props.egressos.id}`} variant="primary">Mais sobre</Button>
                </div>
            </Card.Body>
        </Card>
        </div>
